...
<div class="row">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" style="background-color: #FE840E; border: none;">
        ...
        <ul class="nav navbar-nav" style="background-color: #FE840E;">
          <li><a href="shop_controller.php?action=xemdanhmucsanpham" style="color: #fff;">
                Danh Mục Sản Phẩm
            </a></li>
          <li><a href="shop_controller.php?action=shopinvoices" style="color: #fff;">
                  Đơn Hàng
                </a>
          </li>
          <li><a href="products_controller.php" style="color: #fff;">
                  Thêm Sản Phẩm
                </a>
          </li>
          <li><a href="users_controller.php?action=changepass" style="color: #fff;">
                  Đổi Mật Khẩu
                </a>
          </li>
