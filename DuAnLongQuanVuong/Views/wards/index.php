...
$().ready(function() {
	...
	var validator = $("#formAddWard").validate({
...
<fieldset>
    <legend style="80%">Thêm mới Phường</legend>
            <form id="formAddWard" method="post" action="?action=add_ward">
                <div class="row">
                    <div class="col-md-2">Tên phường: </div> 
                    <div class="col-md-4"> 
                    	<input type="text" id="ward_name" name="ward_name" class="form-control" width="80%" required minlength="3"/>
