...
$().ready(function() {
	...
	var validator = $("#formEditSurcharge").validate({
...
<fieldset>
    <legend style="80%">Phí ship phụ thu</legend>
            <form id="formEditSurcharge" method="post" action="?action=edit_surcharge">
            	<input type="hidden" name="surID" value="<?php if(isset($SurByID)) echo $SurByID[0]->surchargeID?>" />
                <div class="row">
                    <div class="col-md-2">Loại phí</div> 
                    <div class="col-md-4"> 
                    	<input type="text" id="txtname" name="txtname" value="<?php if(isset($SurByID)) echo $SurByID[0]->surchargeName?>" class="form-control" width="80%" required/>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4"> 
                    	<input type="text" id="surcharge" name="surcharge" value="<?php if(isset($SurByID)) echo $SurByID[0]->content?>" class="form-control" width="80%" required/>
